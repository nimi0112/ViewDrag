package com.drag.view.slideviewdrag;
...
public class SwipeBackLayout extends ViewGroup {
    ...
    protected void onFinishInflate() {
        ...
        ViewGroup container_view=(ViewGroup) getChildAt(0);
        int child_count=container_view.getChildCount();

        swipe_button  =  container_view.getChildAt(child_count-1);
